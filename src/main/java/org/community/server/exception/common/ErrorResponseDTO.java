...
/**
 * A class that controls the error messages returned to the client side.
 *
 * @author MC LeeS
 * @created 2022-10-24
...
public class ErrorResponseDTO {
    ...
    public static class ErrorResponseDTOBuilder {
        ...
        /**
         * Disables the timestampe output.
         *
    ...
    public static class CustomFieldError {
        ...
        public CustomFieldError(String rejectedParameter, Object rejectedValue, String reason, Integer internalErrorCode) {
